...
// --
// Offen OM_SET and OM_UPDATE just called same function and if you 
// really need, you can check the MethodID if its OM_SET or OM_UPDATE
// but its unrolled as an example
