...
// --
// Device Commands
void _cmd_0002_Read( struct DEVUnit *unit, struct IORequest *ioreq );
void _cmd_0003_Write( struct DEVUnit *unit, struct IORequest *ioreq );
void _cmd_4000_NSCmd_DeviceQuery( struct IOStdReq *ioreq );

// --
// Device Resources Functions
S32 Resources_Init( struct DEVBase *devBase );
void Resources_Free( struct DEVBase *devBase );
...
S32 Unit_Startup( struct DEVUnit *unit );
...
void Process_Handle_BeginIO( struct DEVUnit *unit );
