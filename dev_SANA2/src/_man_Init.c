...
struct SANA2Base *devBase;
	...
	devBase = (PTR) CreateLibraryTags(
		CLT_DataSize, sizeof( struct SANA2Base ),
	...
	*/
	...
	{
		MYDEBUG( "SANA2 : Opening Resources...  Success" );

		/* Make it public */
		AddDevice( (PTR) devBase );

		/* Optional: small startup message */
		DebugPrintF( "SANA2 : Rock'n Roll\n" );
	}
	else
	{
		MYERROR( "SANA2 : Opening Resources...  Failed" );
